...
if __name__ == "__main__":
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python anoshift_cbrs.py --seed="+str(seed_value)+" --lr="+str(args.lr)+" --w_d="+str(args.w_d)+" --ds="+str(args.ds)+" --gpu="+str(args.gpu)+" --training_cutoff="+str(args.training_cutoff)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
