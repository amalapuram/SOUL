...
def taskwise_lazytrain():
    ...
    truth_agreement_fraction_0 = min(truth_agreement_fraction_0, 0.5)
    truth_agreement_fraction_1 = min(truth_agreement_fraction_1, 0.5)
    ...
    test_set_results = []
    with open(temp_filename, 'w') as fp:
        test_set_results.extend([testing(training_cutoff=training_cutoff, seen_data=True),testing(training_cutoff=training_cutoff, seen_data=False),str(owl_self_labelled_count_class_0), str(owl_self_labelled_count_class_1),str(owl_analyst_labelled_count_class_0), str(owl_analyst_labelled_count_class_1) ])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--wd', type=float, default= 1e-7, metavar='S',help='weight decay')
