...
if __name__ == "__main__":
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python androzoo_avalanche.py --seed="+str(seed_value)+" --ds="+str(args.ds)+" --gpu="+str(args.gpu)+" --training_cutoff="+str(args.training_cutoff)+" --filename="+str(temp_file_name)+" --w_d="+str(args.w_d)+' --cl_strat='+str(args.cl_strat)+" --lr="+str(args.lr)],shell=True,cwd=curr_dir)
        proc.communicate()
