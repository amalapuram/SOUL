...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.01, metavar='S',help='batch memory ratio(default: 0.2)')
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python androzoo_MIR.py --seed="+str(seed_value)+" --lr="+str(args.lr)+" --w_d="+str(args.w_d)+" --batch_size="+str(args.batch_size)+" --ds="+str(args.ds)+" --gpu="+str(args.gpu)+" --training_cutoff="+str(args.training_cutoff)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
