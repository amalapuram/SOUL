...
if __name__ == "__main__":
    ...
    parser.add_argument('--wd', type=float, default=1e-2, metavar='S',help='weight decay(default: 0.01)')
    ...
    for seed_value in seed_list:
        ...
        cmd = ("/home/suresh/anaconda3/envs/temp/bin/python ctu13_spider_owl_neurips2024_2.py --seed="+str(seed_value)
